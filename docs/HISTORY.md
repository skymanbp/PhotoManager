...
- 1.0.0 ✅ 收官（2026-08-28）：版本串五处 bump（package.yaml / Cargo.toml / Cargo.lock / tauri.conf.json / DESIGN-COMMANDS 状态行，`pm --version` 走 Cabal 宏）、README 路线图、`docs/release-notes/v1.0.0.md`；tag `v1.0.0` 由 CI release job 出 zip + NSIS + SHA-256（本机不再编发布二进制）；418/418，警告 0
